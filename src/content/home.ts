...
const animatedA: AnimatedHighlight = {
  ...
  lockBox: true,
  normalize: "height",
  // Alterna fuentes; algunas itálicas
  steps: [
    { bgClass: "bg-black",      charClass: "text-white",           font: "bebas" as FontKey },
    { bgClass: "bg-white",      charClass: "text-black italic",    font: "playfairItalic" as FontKey },
    { bgClass: "bg-[#0A0A0A]",  charClass: "text-[#C7332E]",       font: "anton" as FontKey },
    { bgClass: "bg-[#C7332E]",  charClass: "text-white italic",    font: "ibmItalic" as FontKey },
    { bgClass: "bg-black",      charClass: "text-white",           font: "oswald" as FontKey },
    { bgClass: "bg-white",      charClass: "text-black",           font: "archivoBlack" as FontKey },
  ],
};
...
export const heroContent = {
  ...
  // Nueva config del pin para la A:
  pin: {
    show: true,
    // 'behind' = detrás del fondo de la letra / 'through' = atraviesa por arriba
    mode: "through" as "behind" | "through",
